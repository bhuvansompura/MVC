   ...
   <footer id="contact" class="container-fluid">
    ...
    <script src="<?php echo $this->baseURL; ?>assets/js/jquery-3.2.1.min.js"></script>
    ...
    <script src="<?php echo $this->baseURL; ?>assets/plugins/grid-gallery/js/grid-gallery.min.js"></script>
    <script src="<?php echo $this->baseURL; ?>assets/plugins/scroll-fixed/jquery-scrolltofixed-min.js"></script>
    <script src="<?php echo $this->baseURL; ?>assets/js/script.js"></script>
</html>
