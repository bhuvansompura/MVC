        ...
        <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="<?php echo $this->baseURL; ?>assets/images/slider/slide-02.jpg" alt="First slide">
                ...
                <div class="carousel-item">
                    <img class="d-block w-100" src="<?php echo $this->baseURL; ?>assets/images/slider/slide-03.jpg" alt="Third slide">
           ...
           <div class="row session-title">
            ...
            <div class="row">
                ...
                <div class="col-md-6 image">
                    <img src="<?php echo $this->baseURL; ?>assets/images/about.jpg" alt="">
                </div>
            </div>
       </div>
   </section>
            ...
            <div class="gallery-row row">
                    ...
                    <div class="gg-box">
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g1.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g2.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g3.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g4.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g5.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g6.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g7.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g8.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g9.jpg">
                            </div>
                            <div class="gg-element">
                                <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g10.jpg">
                            </div>
           ...
           <div class="row session-title">
            ...
            <div class="row">
                 <div class="col-md-3 col-sm-6 vd">
                    <div class="bkjiu">
                     <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g1.jpg" alt="">
                 ...
                 <div class="col-md-3 col-sm-6 vd">
                    <div class="bkjiu">
                     <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g2.jpg" alt="">
                        <h4><b>2 - </b>Seeing</h4>
                     <p>Ut wisi enim ad minim veniam, quis laore nostrud exerci tation ulm hedi corper turet suscipit lobortis</p>
                     <button class="btn btn-sm btn-danger">Readmore <i class="fas fa-arrow-right"></i></button>
                     </div>
                 ...
                 <div class="col-md-3 col-sm-6 vd">
                    <div class="bkjiu">
                     <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g3.jpg" alt="">
                 ...
                 <div class="col-md-3 col-sm-6 vd">
                    <div class="bkjiu">
                        <img src="<?php echo $this->baseURL; ?>assets/images/gallery/g4.jpg" alt="">
            ...
            <div class="container">
                ...
                <div class="row news-row">
                    <div class="col-md-6">
                        <div class="news-card">
                            <div class="image">
                                <img src="<?php echo $this->baseURL; ?>assets/images/blog/blog_01.jpg" alt="">
                            </div>
                            <div class="detail">
                    ...
                    <div class="col-md-6">
                        <div class="news-card">
                            <div class="image">
                                <img src="<?php echo $this->baseURL; ?>assets/images/blog/blog_02.jpg" alt="">
                            </div>
                            <div class="detail">
                    ...
                    <div class="col-md-6">
                        <div class="news-card">
                            <div class="image">
                                <img src="<?php echo $this->baseURL; ?>assets/images/blog/blog_03.jpg" alt="">
                            </div>
                            <div class="detail">
                    ...
                    <div class="col-md-6">
                        <div class="news-card">
                            <div class="image">
                                <img src="<?php echo $this->baseURL; ?>assets/images/blog/blog_04.jpg" alt="">
                            </div>
                            <div class="detail">
                                <h3>Latest News about Smarteye</h3>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce fringilla vel nisl a dictum. Donec ut est arcu. Donec hendrerit consectetur adipiscing elit. </p>
